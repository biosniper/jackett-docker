...
RUN wget --no-check-certificate -q https://github.com/Jackett/Jackett/releases/download/v0.7.142/Jackett.Binaries.Mono.tar.gz && tar -zxf Jackett.Binaries.Mono.tar.gz && rm -v /opt/Jackett.Binaries.Mono.tar.gz
